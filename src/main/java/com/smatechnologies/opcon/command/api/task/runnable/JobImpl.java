...
import com.smatechnologies.opcon.restapiclient.model.*;
...
public class JobImpl implements IJob {
    ...
    public WindowsDailyJob getWindowsDailyJobByName(OpconApi opconApi, OpConCliArguments _OpConCliArguments) throws TaskException {
        try {
